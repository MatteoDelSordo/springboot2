...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseDTO> invalidToken (InvalidTokenException exception) {
        ErrorResponseDTO errorResponseDTO = new ErrorResponseDTO ("401", exception.getMessage ());
